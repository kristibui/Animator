...
/**
 * Represents the adapter for the Visual view. This adapter maps out the functions between our
 * Visual view and the provided interface for the views of the Animator.
 */

public class VisualAdapter extends VisualView implements IView {

  /**
   * The constructor for the VisualAdapter.
   *
   * @param am represents the model that is being utilized in order to construct the animation
   */

  public VisualAdapter(PublicAnimationOperations am) {
    super(am);
  }
